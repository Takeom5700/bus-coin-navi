...
const I18N = {
  ja: {
    ...
    addStopSave: "登録する",
    addStopSaved: "登録しました",
    nearestStopLabel: "一番近い登録済みバス停",
    refreshButton: "🔄 更新",
    noNearbyStop: "近くに登録済みのバス停が見つかりません",
    addThisLocationPrompt: "ここをバス停として登録しますか？",
    kmUnit: "km",
    getOffHereButton: "ここで降車する",
    gettingLocation: "現在地を確認中…",
    confirmAlightPrefix: "",
    confirmAlightSuffix: "で降車しますか？",
    yesLabel: "はい",
    noLabel: "いいえ",
    boardedAt: "乗車停留所",
  ...
  en: {
    ...
    addStopSave: "Save",
    addStopSaved: "Saved",
    nearestStopLabel: "Nearest registered stop",
    refreshButton: "🔄 Refresh",
    noNearbyStop: "No registered stop found nearby",
    addThisLocationPrompt: "Register this location as a stop?",
    kmUnit: "km",
    getOffHereButton: "Get off here",
    gettingLocation: "Getting your location…",
    confirmAlightPrefix: "Get off at ",
    confirmAlightSuffix: "?",
    yesLabel: "Yes",
    noLabel: "No",
  ...
  zh: {
    ...
    addStopSave: "注册",
    addStopSaved: "已注册",
    nearestStopLabel: "最近的已注册车站",
    refreshButton: "🔄 刷新",
    noNearbyStop: "附近未找到已注册的车站",
    addThisLocationPrompt: "要将此位置注册为车站吗？",
    kmUnit: "公里",
    getOffHereButton: "在此下车",
    gettingLocation: "正在获取位置…",
    confirmAlightPrefix: "要在",
    confirmAlightSuffix: "下车吗？",
    yesLabel: "是",
    noLabel: "否",
    boardedAt: "上车站",
    wrongStop: "不正确？手动选择",
  ...
  ko: {
    ...
    nearestStopLabel: "가장 가까운 등록된 정류장",
    refreshButton: "🔄 새로고침",
    noNearbyStop: "근처에 등록된 정류장이 없습니다",
    addThisLocationPrompt: "이 위치를 정류장으로 등록하시겠습니까?",
    kmUnit: "km",
    getOffHereButton: "여기서 하차",
    gettingLocation: "위치 확인 중…",
    confirmAlightPrefix: "",
    confirmAlightSuffix: "에서 하차하시겠습니까?",
    yesLabel: "예",
    noLabel: "아니오",
    boardedAt: "승차 정류장",
  ...
  es: {
    ...
    nearestStopLabel: "Parada registrada más cercana",
    refreshButton: "🔄 Actualizar",
    noNearbyStop: "No se encontró ninguna parada registrada cerca",
    addThisLocationPrompt: "¿Registrar esta ubicación como parada?",
    kmUnit: "km",
    getOffHereButton: "Bajar aquí",
    gettingLocation: "Obteniendo ubicación…",
    confirmAlightPrefix: "¿Bajar en ",
    confirmAlightSuffix: "?",
    yesLabel: "Sí",
    noLabel: "No",
  ...
  fr: {
    ...
    nearestStopLabel: "Arrêt enregistré le plus proche",
    refreshButton: "🔄 Actualiser",
    noNearbyStop: "Aucun arrêt enregistré trouvé à proximité",
    addThisLocationPrompt: "Enregistrer cet endroit comme arrêt ?",
    kmUnit: "km",
    getOffHereButton: "Descendre ici",
    gettingLocation: "Localisation en cours…",
    confirmAlightPrefix: "Descendre à ",
    confirmAlightSuffix: " ?",
    yesLabel: "Oui",
    noLabel: "Non",
  ...
  it: {
    ...
    nearestStopLabel: "Fermata registrata più vicina",
    refreshButton: "🔄 Aggiorna",
    noNearbyStop: "Nessuna fermata registrata trovata nelle vicinanze",
    addThisLocationPrompt: "Registrare questa posizione come fermata?",
    kmUnit: "km",
    getOffHereButton: "Scendi qui",
    gettingLocation: "Rilevamento posizione…",
    confirmAlightPrefix: "Scendere a ",
    confirmAlightSuffix: "?",
    yesLabel: "Sì",
    noLabel: "No",
  ...
  ar: {
    ...
    nearestStopLabel: "أقرب محطة مسجلة",
    refreshButton: "🔄 تحديث",
    noNearbyStop: "لم يتم العثور على محطة مسجلة قريبة",
    addThisLocationPrompt: "هل تريد تسجيل هذا الموقع كمحطة؟",
    kmUnit: "كم",
    getOffHereButton: "النزول هنا",
    gettingLocation: "جارٍ تحديد الموقع…",
    confirmAlightPrefix: "هل تريد النزول في ",
    confirmAlightSuffix: "؟",
    yesLabel: "نعم",
    noLabel: "لا",
  ...
  id: {
    ...
    nearestStopLabel: "Halte terdaftar terdekat",
    refreshButton: "🔄 Segarkan",
    noNearbyStop: "Tidak ada halte terdaftar di dekat sini",
    addThisLocationPrompt: "Daftarkan lokasi ini sebagai halte?",
    kmUnit: "km",
    getOffHereButton: "Turun di sini",
    gettingLocation: "Mendapatkan lokasi…",
    confirmAlightPrefix: "Turun di ",
    confirmAlightSuffix: "?",
    yesLabel: "Ya",
    noLabel: "Tidak",
  ...
  ms: {
    ...
    nearestStopLabel: "Perhentian berdaftar terdekat",
    refreshButton: "🔄 Muat semula",
    noNearbyStop: "Tiada perhentian berdaftar dijumpai berhampiran",
    addThisLocationPrompt: "Daftarkan lokasi ini sebagai perhentian?",
    kmUnit: "km",
    getOffHereButton: "Turun di sini",
    gettingLocation: "Mendapatkan lokasi…",
    confirmAlightPrefix: "Turun di ",
